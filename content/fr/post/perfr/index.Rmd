...
Ceci dit, des efforts peuvent être rentables dans les cas où le temps d’exécution est critique: c’est l’objet de ce document. On se reportera à [*Advanced R*](https://adv-r.hadley.nz/) d’Hadley Wickam pour une présentation plus détaillée.
...
* [lire en ligne](https://ericmarcon.github.io/Performance-R/Performance-R.html);
* [télécharger](https://ericmarcon.github.io/Performance-R/Performance-R.pdf).
