...
tags: []
categories: []
date: 2020-04-17T16:19:27-03:00
lastmod: 2020-04-17T16:19:27-03:00
featured: false
draft: false
...
* Mettre à jour les fichiers déplacés. Pour celà, afficher le dépôt [Academic-Kickstart](https://github.com/sourcethemes/academic-kickstart) sur GitHub:

![Dernier Commit](kickstart.png)
  
  * Cliquer sur le texte décrivant le dernier *Commit*;
  * Examiner les modifications effectuées sur les fichiers non mis à jour et les reporter manuellement dans les fichiers concernées. Ici, 7 lignes doivent être ajoutées au fichier `config.toml`, et le chemp "name" doit être renommé "title" dans les deux exemplaires de `authors/admin/_index.md`.
...
Il reste à mettre à jour le sous-module du thème *Academic*, qui est dépôt Git lui-même.
